                ...
                <div class="row g-3 mb-4">
                        ...
                        <select id="id_gunung" name="id_gunung"
                            ...
                            @foreach ($mountains as $gunung)
                                <option value="{{ $gunung->id }}"
                                    {{ $gunung->id == $trail->id_gunung ? 'selected' : '' }}>{{ $gunung->nama }}</option>
                            @endforeach
                        </select>
                        @error('id_gunung')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                            value="{{ old('nama', $trail->nama) }}" placeholder="Masukkan nama jalur">
                        @error('nama')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <select id="province_id" name="province_id"
                            ...
                            @foreach ($provinces as $province)
                                <option value="{{ $province->id }}"
                                    {{ $province->id == $trail->province_id ? 'selected' : '' }}>{{ $province->name }}
                                </option>
                            @endforeach
                        </select>
                        @error('province_id')
                        ...
                        <select id="regency_id" name="regency_id"
                            ...
                            @foreach ($regencies as $regency)
                                <option value="{{ $regency->id }}"
                                    {{ $regency->id == $trail->regency_id ? 'selected' : '' }}>{{ $regency->name }}
                                </option>
                            @endforeach
                        </select>
                        @error('regency_id')
                        ...
                        <select id="district_id" name="district_id"
                            ...
                            @foreach ($districts as $district)
                                <option value="{{ $district->id }}"
                                    {{ $district->id == $trail->district_id ? 'selected' : '' }}>{{ $district->name }}
                                </option>
                            @endforeach
                        </select>
                        @error('district_id')
                        ...
                        <select id="village_id" name="village_id"
                            ...
                            @foreach ($villages as $village)
                                <option value="{{ $village->id }}"
                                    {{ $village->id == $trail->village_id ? 'selected' : '' }}>{{ $village->name }}
                                </option>
                            @endforeach
                        </select>
                        @error('village_id')
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="jarak" class="form-control @error('jarak') is-invalid @enderror"
                            value="{{ old('jarak', $trail->jarak) }}" placeholder="5.5">
                        @error('jarak')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="elevasi" class="form-control @error('elevasi') is-invalid @enderror"
                            value="{{ old('elevasi', $trail->elevasi) }}" placeholder="1200">
                        @error('elevasi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="durasi" class="form-control @error('durasi') is-invalid @enderror"
                            value="{{ old('durasi', $trail->durasi) }}" placeholder="6">
                        @error('durasi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="biaya" class="form-control @error('biaya') is-invalid @enderror"
                            value="{{ old('biaya', $trail->biaya) }}" placeholder="25000">
                        @error('biaya')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($trail->gambar_jalur)
                            <div class="mt-2">
                                <img src="{{ asset('/storage/images/' . $trail->gambar_jalur) }}" alt="Gambar"
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Upload GPX Jalur (Opsional)</label>
                        ...
                        @error('gpx_file')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="text-muted d-block">Upload file baru untuk replace route preview.</small>
                        @if (is_array($trail->route_points) && count($trail->route_points) > 0)
                            <small class="text-success d-block mt-1">Titik tersimpan saat ini:
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="latitude"
                            ...
                            value="{{ old('latitude', $trail->latitude) }}" placeholder="-7.2575">
                        @error('latitude')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="longitude"
                            ...
                            value="{{ old('longitude', $trail->longitude) }}" placeholder="112.7521">
                        @error('longitude')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="panorama_score" class="form-select @error('panorama_score') is-invalid @enderror">
                            @foreach(config('dss_labels.panorama_score') as $val => $label)
                                <option value="{{ $val }}" {{ old('panorama_score', $trail->panorama_score ?? 3) == $val ? 'selected' : '' }}>
                                    {{ $val }} – {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="fasilitas_score" class="form-select @error('fasilitas_score') is-invalid @enderror">
                            @foreach(config('dss_labels.fasilitas_score') as $val => $label)
                                <option value="{{ $val }}" {{ old('fasilitas_score', $trail->fasilitas_score ?? 3) == $val ? 'selected' : '' }}>
                                    {{ $val }} – {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="safety_score" class="form-select @error('safety_score') is-invalid @enderror">
                            @foreach(config('dss_labels.safety_score') as $val => $label)
                                <option value="{{ $val }}" {{ old('safety_score', $trail->safety_score ?? 3) == $val ? 'selected' : '' }}>
                                    {{ $val }} – {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="crowd_level" class="form-select @error('crowd_level') is-invalid @enderror">
                            @foreach(config('dss_labels.crowd_level') as $val => $label)
                                <option value="{{ $val }}" {{ old('crowd_level', $trail->crowd_level ?? 3) == $val ? 'selected' : '' }}>
                                    {{ $val }} – {{ $label }}
                                </option>
                            @endforeach
                        </select>
