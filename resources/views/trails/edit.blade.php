        ...
        <form action="{{ route('trails.update', $trail->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="elevasi" class="form-control @error('elevasi') is-invalid @enderror" value="{{ old('elevasi', $trail->elevasi) }}" placeholder="1200">
                    @error('elevasi')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="col-md-4">
                    <label class="form-label">Durasi (jam)</label>
                    <input type="text" name="durasi" class="form-control @error('durasi') is-invalid @enderror" value="{{ old('durasi', $trail->durasi) }}" placeholder="6">
                ...
                <div class="col-md-4">
                    ...
                    <select name="tingkat_kesulitan" class="form-select @error('tingkat_kesulitan') is-invalid @enderror">
                        <option value="mudah" {{ old('tingkat_kesulitan', $trail->tingkat_kesulitan) === 'mudah' ? 'selected' : '' }}>Mudah</option>
                        <option value="sedang" {{ old('tingkat_kesulitan', $trail->tingkat_kesulitan) === 'sedang' ? 'selected' : '' }}>Sedang</option>
                        <option value="sulit" {{ old('tingkat_kesulitan', $trail->tingkat_kesulitan) === 'sulit' ? 'selected' : '' }}>Sulit</option>
                        <option value="sangat_sulit" {{ old('tingkat_kesulitan', $trail->tingkat_kesulitan) === 'sangat_sulit' ? 'selected' : '' }}>Sangat Sulit</option>
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    @if(is_array($trail->route_points) && count($trail->route_points) > 0)
                        <small class="text-success d-block mt-1">Titik tersimpan saat ini: {{ count($trail->route_points) }} titik</small>
                    @endif
                </div>
