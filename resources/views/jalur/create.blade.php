                            ...
                            <form action="{{ route('jalur.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="jarak"
                                        ...
                                        value="{{ old('jarak') }}" placeholder="Masukkan Jarak Jalur">
                                    @error('jarak')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="map_basecamp"
                                        ...
                                        value="{{ old('map_basecamp') }}" placeholder="Masukkan Link Map Basecamp">
                                    @error('map_basecamp')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="biaya"
                                        ...
                                        value="{{ old('biaya') }}" placeholder="Masukkan Biaya Pendakian">
                                    @error('biaya')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <p class="text-muted">Sistem akan otomatis membuat akun untuk penjaga jalur dengan level 2
                                </p>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="penjaga_name"
                                        ...
                                        value="{{ old('penjaga_name') }}" placeholder="Masukkan Nama Penjaga Jalur">
                                    @error('penjaga_name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="email" name="penjaga_email"
                                        ...
                                        value="{{ old('penjaga_email') }}" placeholder="Masukkan Email Penjaga">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="penjaga_phone"
                                        ...
                                        value="{{ old('penjaga_phone') }}" placeholder="Masukkan Nomor Telepon">
                                    @error('penjaga_phone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="penjaga_address" class="form-control @error('penjaga_address') is-invalid @enderror" rows="3"
                                        placeholder="Masukkan Alamat Penjaga">{{ old('penjaga_address') }}</textarea>
                                ...
                                <div class="alert alert-info">
                                    <strong>Informasi:</strong> Password default untuk penjaga jalur adalah
                                    <strong>password123</strong>. Penjaga dapat mengubahnya setelah login.
                                </div>
