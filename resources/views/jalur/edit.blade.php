                            ...
                            <form action="{{ route('jalur.update', $jalur->id) }}" method="POST"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="nama"
                                        ...
                                        value="{{ old('nama', $jalur->nama) }}" placeholder="Masukkan Nama Jalur">
                                    @error('nama')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <select id="province_id" name="province_id"
                                        ...
                                        @foreach ($provinces as $province)
                                            <option value="{{ $province->id }}"
                                                {{ $province->id == $jalur->province_id ? 'selected' : '' }}>
                                                {{ $province->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select id="regency_id" name="regency_id"
                                        ...
                                        @foreach ($regencies as $regency)
                                            <option value="{{ $regency->id }}"
                                                {{ $regency->id == $jalur->regency_id ? 'selected' : '' }}>
                                                {{ $regency->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select id="district_id" name="district_id"
                                        ...
                                        @foreach ($districts as $district)
                                            <option value="{{ $district->id }}"
                                                {{ $district->id == $jalur->district_id ? 'selected' : '' }}>
                                                {{ $district->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select id="village_id" name="village_id"
                                        ...
                                        @foreach ($villages as $village)
                                            <option value="{{ $village->id }}"
                                                {{ $village->id == $jalur->village_id ? 'selected' : '' }}>
                                                {{ $village->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="jarak"
                                        class="form-control @error('jarak') is-invalid @enderror"
                                        value="{{ old('jarak', $jalur->jarak) }}" placeholder="Masukkan Jarak Jalur">
                                    @error('jarak')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="map_basecamp"
                                        ...
                                        placeholder="Masukkan Link Map Basecamp">
                                    @error('map_basecamp')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control @error('gambar_jalur') is-invalid @enderror"
                                        id="gambar_jalur" name="gambar_jalur">
                                    @error('gambar_jalur')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="biaya"
                                        ...
                                        value="{{ old('biaya', $jalur->biaya) }}" placeholder="Masukkan Biaya Pendakian">
                                    @error('biaya')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                @if ($jalur->penjaga)
                                    <hr class="my-4">
                                    <h4 class="font-weight-bold mb-3" style="color: #117958;">Data Penjaga Jalur</h4>

                                    <div class="alert alert-info">
                                        <strong>Penjaga Saat Ini:</strong> {{ $jalur->penjaga->name }}
                                        ({{ $jalur->penjaga->email }})
                                    </div>

                                    <div class="form-group mb-3">
                                        <label class="font-weight-bold">Nama Penjaga</label>
                                        <input type="text" name="penjaga_name"
                                            class="form-control @error('penjaga_name') is-invalid @enderror"
                                            value="{{ old('penjaga_name', $jalur->penjaga->name) }}"
                                            placeholder="Masukkan Nama Penjaga Jalur">
                                        @error('penjaga_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group mb-3">
                                        <label class="font-weight-bold">Email Penjaga</label>
                                        <input type="email" name="penjaga_email"
                                            class="form-control @error('penjaga_email') is-invalid @enderror"
                                            value="{{ old('penjaga_email', $jalur->penjaga->email) }}"
                                            placeholder="Masukkan Email Penjaga">
                                        @error('penjaga_email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group mb-3">
                                        <label class="font-weight-bold">No. Telepon Penjaga</label>
                                        <input type="text" name="penjaga_phone"
                                            class="form-control @error('penjaga_phone') is-invalid @enderror"
                                            value="{{ old('penjaga_phone', $jalur->penjaga->phone) }}"
                                    ...
                                    <div class="form-group mb-3">
                                        <label class="font-weight-bold">Alamat Penjaga (Opsional)</label>
                                        <textarea name="penjaga_address" class="form-control @error('penjaga_address') is-invalid @enderror" rows="3"
                                            placeholder="Masukkan Alamat Penjaga">{{ old('penjaga_address', $jalur->penjaga->address) }}</textarea>
                                        @error('penjaga_address')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        @enderror
                                ...
                                <div class="d-flex justify-content-start">
                                    <button type="submit" class="btn"
                                        style="background-color: #117958; color: white; border: none; margin-right: 10px;">Simpan</button>
